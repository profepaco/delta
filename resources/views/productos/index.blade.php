                          ...
                          <tbody class="bg-white dark:bg-gray-800 dark:text-gray-200">
                            @foreach ($productos as $producto)
                              <tr>
                                ...
                                <x-table-column class="py-4">
                                  <a href="{{route('productos.show',['producto'=>$producto])}}" class="text-gray-200 hover:text-gray-400 mx-2">
                                  ...
                                  <a href="{{route('productos.edit',['producto'=>$producto])}}" class="text-indigo-200 hover:text-indigo-400 mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
